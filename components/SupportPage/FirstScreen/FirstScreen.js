...
export default function FirstScreen() {
  ...
  return(
    ...
    <Box className={classes.root}>
      <Box>
        <FastTypography data-aos="fade-up" type="h1" weight="bold" style={{textAlign: 'center'}}>Support Galaxis</FastTypography>
        <FastTypography data-aos="fade-up" type="h4" noMargin style={{marginBottom: 25}} className={classes.typography}>Want in? Voice your support to Galaxis to show people our potential.</FastTypography>
      </Box>
      <AnchorLink offset='100' href='#contact-us' className={classes.glitchWrapper} data-aos="fade-up">
